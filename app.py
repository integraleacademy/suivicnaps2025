...
def attestation(id):
    ...
    nom, prenom, formation, session, lien = dossier[1], dossier[2], dossier[3], dossier[4], dossier[5]
    ...
    row = table.rows[0]
    row.cells[0].paragraphs[0].add_run().add_picture('static/signature.png', width=Inches(2))
    row.cells[1].paragraphs[0].add_run().add_picture('static/tampon.png', width=Inches(2.5))
